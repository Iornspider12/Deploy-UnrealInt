...
async def main(
    ...
    tts = TextToSpeech(tts_instance="ws://3.141.47.208:8080", voice=voice)
    await tts.start_up()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        default="""Hello, 
this is a test of the moshi text to speech system, 
this should result in some nicely sounding generated voice.
congratulations,
The test worked and you are hearing it from server now.""",
    )
